...
const MainTitle: FC<Props> = ({state}: Props) => {
    return (
        <>
            <div className=" w-full dark:bg-darkbg bg-gradient-to-b from-[#243875] to-[#3668DA] ">
                ...
                <p className="text-white md:text-sm text-xl">One third of {state} Residents that fill out this survey get major cash for their accident.</p>
